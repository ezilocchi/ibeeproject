 ...
 *
 * @version Climas.java
 * @version Created on 19/03/2010, 17:00:35
 * @author CyberShark
 */
public class Climas extends AbstractPageBean {
    ...
    private GestorClima gestC = new GestorClima();
    private GestorZona gestZ = new GestorZona();

    public GestorZona getGestZ() {
        return gestZ;
    }

    public void setGestZ(GestorZona gestZ) {
        this.gestZ = gestZ;
    }

    public GestorClima getGestC() {
        return gestC;
    }

    public void setGestC(GestorClima gestC) {
        this.gestC = gestC;
    }

    public ArrayList getClima() {
        return clima;
    }
    ...
    private void cargarZonas() {
        ...
        for (int i = 0; i < zone.size(); i++) {
            Zona aux = (Zona) zone.get(i);
            this.getZonas().add(new SelectItem(aux.getIdZona(), aux.getZona()));
        }
    }
