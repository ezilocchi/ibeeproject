 ...
 *
 * @version modificarCajon.java
 * @version Created on 26-ago-2009, 18:39:31
 * @author farias.facundo
 */
public class modificarCajon extends AbstractFragmentBean {
    ...
    public String actionAceptar() {
        ...
        try {
            gestor.updateUno(cajon);
        } catch (Exception ex) {
            // TODO
            ex.printStackTrace();
            System.out.print("Error en la inserción BD: ManagedBean modificarCajon");
        }
