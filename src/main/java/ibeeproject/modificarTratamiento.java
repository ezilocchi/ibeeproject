 ...
 *
 * @version modificarTratamiento.java
 * @version Created on 23-ago-2009, 13:40:18
 * @author carranza.matias
 */

public class modificarTratamiento extends AbstractFragmentBean {
    ...
    public String actionAceptar() {
        ...
        try {
            gestor.updateUno(tratamiento);
        } catch (Exception ex) {
            // TODO
            ex.printStackTrace();
            System.out.print("Error en la inserción BD: ManagedBean modificarTratamiento");
        }
    ...
    public String actionCancelar() {
        // Cancela
        consultarTratamientos consultar = (consultarTratamientos) getBean("consultarTratamientos");
