 ...
 *
 * @version eliminarTipoDeActividad.java
 * @version Created on 18-sep-2009, 21:37:36
 * @author farias.facundo
 */
public class eliminarTipoDeActividad extends AbstractFragmentBean {
    ...
    public eliminarTipoDeActividad() {
    }
    ...
    public String actionAceptar() {
        ...
        try {
            ...
            gestor.deleteUno(this.getTipoDeActividad());
        } catch (Exception ex) {
            // TODO
            ex.printStackTrace();
            System.out.print("Error en la eliminación BD: ManagedBean eliminarTipoActividad");
        }
