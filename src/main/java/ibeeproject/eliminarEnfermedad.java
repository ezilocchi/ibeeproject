 ...
 *
 * @version eliminarEnfermedad.java
 * @version Created on 01-jul-2009, 22:24:17
 * @author farias.facundo 
 */

public class eliminarEnfermedad extends AbstractFragmentBean {
    ...
    public String actionAceptar() {
        ...
        try {
            gestorEnfermedad.deleteUno(this.getEnfermedad());
        } catch (Exception ex) {
            // TODO
            ex.printStackTrace();
            System.out.print("Error en la eliminación BD: ManagedBean eliminarEnfermedad");
        }
