...
import ibeeproject.persistencia.GestorEstadoActividad;
 ...
 *
 * @version Actividades.java
 * @version Created on 05-oct-2009, 18:36:50
 * @author farias.facundo
 */
public class Actividades extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("Actividades Initialization Failure", e);
    ...
    private void getDBEstados() {
        GestorEstadoActividad gestor = new GestorEstadoActividad();
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBEstados");
        }
        for (int i = 0; i < datos.size(); i++) {
            estado = (EstadoActividad) datos.get(i);
            this.getEstados().add(new SelectItem(estado.getNumero(), estado.getEstado()));
        }
    }
    ...
    private void getDBTiposDeActividad() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBTiposDeActividad");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBApiares() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBApiares");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBEmpleados() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBEmpleados");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBColmenas() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBColmenas");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    public void getDBTiposDeTarea(String codTipoActividad) {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBTiposDeTarea");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBAlarmas() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBAlarmas");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBLayouts() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBLayouts");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBZonas() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBZonas");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBFamilias() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBFamilias");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBCajones() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBCajones");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBEnfermedades() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBEnfermedades");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBTratamientos() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBTratamientos");
        }
        for (int i = 0; i < datos.size(); i++) {
    ...
    private void getDBSintomas() {
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.print("Error en la consulta BD: Actividades.getDBSintomas");
        }
        for (int i = 0; i < datos.size(); i++) {
