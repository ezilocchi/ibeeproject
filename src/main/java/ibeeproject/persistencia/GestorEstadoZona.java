 ...
 */
public class GestorEstadoZona implements Manejable {

    private ConexionPoolBD connPool;
    private Connection conn;
    private ArrayList list;

    public GestorEstadoZona() {
    ...
    public ArrayList getTodos() throws Exception {
        try {
            ...
            while (rs.next()) {
                EstadoZona estado = new EstadoZona();
            ...
            a.printStackTrace();
            System.out.print("Error en conexion BD: GestorEstadozona! (getTodos)");
        }
        return list;
    }
    ...
    public Object getUno(int idObjeto) throws Exception {
        ...
        try {
            ...
            a.printStackTrace();
            System.out.print("Error en conexion BD: GestorEstadozona! (getUno)");
        }
        return estado;
    }
