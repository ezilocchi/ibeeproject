 ...
 *
 * @version agregarEnfermedad.java
 * @version Created on 01-jul-2009, 22:23:26
 * @author farias.facundo 
 */
public class agregarEnfermedad extends AbstractFragmentBean {
    ...
    public String actionAceptar() {
        ...
        Enfermedad aux = (Enfermedad) gestorEnfermedad.getUltimo();
        this.getEnfermedad().setNumero(aux.getNumero() + 1);

        try {
            // Inserto la enfermedad
            gestorEnfermedad.insertUno(enfermedad);
        } catch (Exception ex) {
            // TODO
            ex.printStackTrace();
            System.out.print("Error en la inserción BD: ManagedBean agregarEnfermedad");
        }
