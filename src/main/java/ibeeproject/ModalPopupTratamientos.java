 ...
 */
public class ModalPopupTratamientos extends AbstractFragmentBean {
    ...
    public String acepta() {
        try {
            ...
            if (e.isAgregar()) {
                ...
                agregar.getEnfermedad().getTratamientos().add((Tratamiento)gestorTratamiento.getUno(this.getTratamiento()));
            }
            if (e.isModificar()) {
                modificarEnfermedad modificar = (modificarEnfermedad) getBean("modificarEnfermedad");
                modificar.getEnfermedad().getTratamientos().add((Tratamiento)gestorTratamiento.getUno(this.getTratamiento()));
            }
        } catch (Exception ex) {
            ex.printStackTrace();
