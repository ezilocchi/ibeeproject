 ...
 *
 * @version modificarLayout.java
 * @version Created on 20-sep-2009, 12:23:41
 * @author Administrador
 */

public class modificarLayout extends AbstractFragmentBean {
    ...
    public void setLayout(Layout layaout) {
        ...
        posiciones = gestPos.getUnoLayout(this.layout.getIdLayout());
    ...
    public String action_modificar() {
        ...
        gestLay.updateUno(this.layout);
        if(this.isNuevasPosiciones()){
        gestPos.deleteUno(this.getLayout());
    ...
    public String setearPosicion() {
        ...
        GestorLayout gestLay = new GestorLayout();
        if(gestLay.getAsignado(this.getLayout())==0){
                    ...
                    for (int j = 1; j < layout.getAncho() + 1; j++) {
                        ...
                        boton.addActionListener(new javax.faces.event.ActionListener() {
                            ...
                            public void processAction(ActionEvent event) {
                                for (int k = 0; k < modificarLayout.this.getPosiciones().size(); k++) {
                                    ...
                                    posici.setLayout(modificarLayout.this.getLayout());
                                    posici.setPosHorizontal(posicion[0]);
                                    posici.setPosVertical(posicion[1]);
                                    modificarLayout.this.nvasPosiciones.add(posici);
                                    boton.setImage("/resources/icons/posicion_vacia.png");
                                    modificarLayout.this.setCantidad_max(modificarLayout.this.nvasPosiciones.size());
