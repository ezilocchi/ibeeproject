 ...
 *
 * @version Layout.java
 * @version Created on 19-sep-2009, 19:32:38
 * @author Administrador
 */

public class Layouts extends AbstractPageBean {
    ...
    public Layout getUltimoLay() {
        return (Layout)gestLay.getUltimo();
    }

    public void setUltimoLay(Layout ultimoLay) {
        this.ultimoLay = ultimoLay;
    }
    ...
    public void cargarLayouts() {
        ...
        this.setLayouts(gestLay.getTodos());
        this.setUltimoLay((Layout)gestLay.getUltimo());
    }

    public void cargarPosiciones() {
        this.gestPos = new GestorPosicion();
        this.setPosiciones(gestPos.getTodos());
    }
}
